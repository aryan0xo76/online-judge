...
function AddProblem() {
  ...
  const handleUp = (index) => {
    if (index !== 0) {
      ...
      const new_output_tests = [...output_tests];
      [new_output_tests[index], new_output_tests[index - 1]] = [
        new_output_tests[index - 1],
        new_output_tests[index],
      ];
      [new_input_tests[index], new_input_tests[index - 1]] = [
        new_input_tests[index - 1],
        new_input_tests[index],
      ];
      setInput_tests(new_input_tests);
      setOutput_tests(new_output_tests);
    }
